...
%\usepackage[sorting=none,style=alphabetic]{biblatex}
...
\newcommand{\labeltext}[3][]{%
 ...
 %   \ifx\tst\empty\def\@currentlabel{\refmarkup{#2}}{\label{#3}}%
    \def\@currentlabel{\refmarkup{#1}}{\label{#3}}%\fi%
    \@esphack%
\stackrel{\scalebox{.6}{(#2)}}{=}
...
\newcommand{\eqzxa}[1]{
\labeltext[(\arabic{eq})]{\arabic{eq}}{#1}
\stepcounter{eq}
}
...
\newcommand{\pullbackcorner}[1][dl]{\save*!/#1-1.5pc/#1:(-1,1)@^{pb}\restore}

\newcommand{\pushoutcorner}[1][dl]{\save*!/#1-1.5pc/#1:(-1,1)@^{po}\restore}

\newcommand{\pullbackcornermini}[1][dl]{\save*!/#1-1pc/#1:(-1,1)@^{pb}\restore}
...
\newcommand{\Dfrac}[2]{%
  \ooalign{%
    $\genfrac{}{}{2pt}1{#1}{#2}$\cr%
    $\color{white}\genfrac{}{}{1pt}1{\phantom{#1}}{\phantom{#2}}$}%
}

\newcommand{\Ifrac}[2]{%
  \ooalign{%
    $\genfrac{}{}{0pt}1{#1}{#2}$\cr%
    $\color{white}\genfrac{}{}{0pt}1{\phantom{#1}}{\phantom{#2}}$}%
}
...
\begin{tikzpicture}[scale=.7]
	\begin{pgfonlayer}{nodelayer}
		\node [style=none] (26) at (32, -0.25) {};
		\node [style=none] (27) at (32.5, 0) {};
		\node [style=none] (28) at (31.5, 0) {};
	\end{pgfonlayer}
...
\begin{tikzpicture}[scale=.7]
	\begin{pgfonlayer}{nodelayer}
		\node [style=none] (29) at (34, 0) {};
		\node [style=none] (30) at (34.5, -0.25) {};
		\node [style=none] (31) at (33.5, -0.25) {};
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
...
\newcommand{\zcirc}{\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=Z] (8) at (23, 0) {};
		\node [style=none] (9) at (23, -0.14) {};
	\end{pgfonlayer}
\end{tikzpicture}}

\newcommand{\xcirc}{\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=X] (8) at (23, 0) {};
		\node [style=none] (9) at (23, -0.14) {};
	\end{pgfonlayer}
\end{tikzpicture}}

\newcommand{\skewpullbackcornernudged}[1][dl]{\save*!/#1-2pc/#1:(-.5,1)@^{|>}\restore}
...
\newcommand{\sfiso}{{\sf is}}
\newcommand{\sfinj}{{\sf in}}
\newcommand{\sfpariso}{{\sf pis}}
\newcommand{\sfpar}{{\sf pr}}
\newcommand{\sfspan}{{\sf sp}}
\newcommand{\subiso}{{\sf sis}}
\newcommand{\subinj}{{\sf sin}}
\newcommand{\acb}{{\sf acb}}
\newcommand{\sfmono}{{\sf Mono}}



\newcommand{\fa}{{\sf fa}}
\newcommand{\sfa}{{\sf sfa}}
\newcommand{\csfa}{{\sf csfa}}
...
\definecolor{cellone}{RGB}{100,100,150}
\definecolor{cellthree}{RGB}{90,250,90}
\definecolor{celltwo}{RGB}{140,110,110}



\tikzset{cellone/.style={pattern={crosshatch dots},pattern color=cellone}}
\tikzset{celltwo/.style={pattern={dots},pattern color=celltwo}}
\tikzset{cellthree/.style={pattern={crosshatch dots},pattern color=cellthree}}
...
\setenumerate{align=left,itemsep=1pt,topsep=1.5pt}
\setitemize{align=left,itemsep=1pt,topsep=1.5pt}
\setdescription{align=left, itemsep=1pt,topsep=1.5pt,labelindent=\parindent}
...
%  \pushQED{\qed}%
%  \normalfont
%  \topsep2pt \partopsep2pt % no space before
%  \trivlist
%  \item[\hskip\labelsep
%        \itshape
