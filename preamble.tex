...
\newcommand{\eqzxa}[1]{
\labeltext[(\arabic{equation})]{\arabic{equation}}{#1}
...
\setitemize{align=left}
\setdescription{align=left}
\setenumerate{itemsep=1pt,topsep=1.5pt}
\setitemize{itemsep=1pt,topsep=1.5pt}
\setdescription{itemsep=1pt,topsep=1.5pt}
