...
$$
\end{definition}
Concretely, the biaffine fragment of the qubit stabilizer ZX-calculus corresponds to the real fragment of qubit stabilizer circuits, where the stabilizers do not contain tensor factors of the form $\mathcal{Z}\mathcal{X}$.
