...
$$
\left(X\xrightarrow{(f,S)} Y\right) \sim \left(\xrightarrow{(g,T)} Y\right)  \iff
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
...
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=none] (0) at (38.15, 0) {};
		\node [style=none] (1) at (38.625, -1.75) {};
		\node [style=none] (2) at (39.125, -1) {};
		\node [style=none] (3) at (39.125, 0) {};
		\node [style=none] (4) at (39.15, 1.25) {};
		\node [style=map] (5) at (38.125, -0.025) {$|b_j\rangle$};
		\node [style=map] (6) at (38.125, -1.025) {$\langle b_j|$};
		\node [style=none] (7) at (38.15, 1.25) {};
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [in=0, out=-90] (2.center) to (1.center);
		\draw [in=270, out=90] (2.center) to (3.center);
		\draw [in=270, out=90] (0.center) to (4.center);
		\draw [in=-180, out=-90] (6) to (1.center);
		\draw [in=-90, out=90] (3.center) to (7.center);
	\end{pgfonlayer}
\end{tikzpicture}\
,\hspace*{1cm}
\begin{tikzpicture}
...
Notice how the $Z$-spiders compare standard basis elements and the $X$-spiders compare their sums:
...
In $\CPM(\FHilb)$ the scalars are the real numbers so that:

$$ e^{  2\pi \cdot i  \cdot a }f=f$$


Therefore, when specifying phases, we fix $\theta_0=0$ to avoid having extra degrees of freedom.
