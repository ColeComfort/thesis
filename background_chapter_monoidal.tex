...
The following result has probably been known for quite some time.  The earliest reference I could find is the case over a field \cite[Figure 26]{lafont}:
...
One can performmatrix multiplication by pulling all of the white generators to the bottom and grey generators to the top so that the elements of the commutative semiring live in the middle.  Consider the following example:
