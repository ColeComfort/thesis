...
So that monoidal categories equipped with a supply of (\dag-)Frobenius alegbras compatible with the monoidal structure is (\dag-)compact closed with $X^*=X$ for all objects $X$.
