...
\begin{definition}
Let $\Stab_p$ denote the prop of quopit stabilizer circuits modulo nonzero scalars, regarded as a \dag-compact closed category with respect to the Hermitian adjoint and standard basis.
\end{definition}
...
\end{proof}
This spider notation gives a slick description for electrical circuits:\begin{remark}
