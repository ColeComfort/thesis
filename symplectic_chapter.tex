...
\begin{remark}
\label{rem:ranknull}
From Lemma \ref{cor:copy}, recall that given a matrix $A:n\to m$ in $\cb_k$, then the image and kernel have the following graphical  representation:
...
Recall how Weyl operators form a unitary operator basis.  So that given any error on a quantum channel we can decompose it as a linear combination of Weyl operators  $W(e)$.
