...
Where we on the left we have the discard map, as well as its representation in terms of the bastard spider notation for stabilizer circuits.
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		\draw (2.center) to (1);
		\draw (1) to (0.center);
		\draw [style=red, in=-15, out=90] (3.center) to (1);
	\end{pgfonlayer}
\end{tikzpicture}
\ \right\rrbracket
:=
\begin{tikzpicture}
	...
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [style=red, in=-15, out=90, looseness=1.25] (4.center) to (5);
		\draw (5) to (3.center);
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [style=red] (10.center) to (14.center);
	\end{pgfonlayer}
\end{tikzpicture}
 \ ,
\hspace*{.5cm}
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		\draw (6.center) to (5);
		\draw (5) to (4.center);
		\draw [style=red, in=-165, out=90] (7.center) to (5);
	\end{pgfonlayer}
\end{tikzpicture}
\ \right\rrbracket
:=
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=none] (33) at (6.5, -2.75) {};
		\node [style=none] (34) at (7, -4.25) {};
		\node [style=none] (36) at (8, -2.75) {};
		\node [style=Z] (38) at (6.5, -3.5) {};
		\node [style=none] (40) at (7, -5) {};
		\node [style=none] (41) at (8, -5) {};
		\node [style=Z] (42) at (8, -4.25) {};
		\node [style=none] (43) at (6, -4.25) {};
		\node [style=none] (44) at (6, -5) {};
		\node [style=Z] (45) at (8, -3.5) {};
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [in=-30, out=90] (34.center) to (38);
		\draw (38) to (33.center);
		\draw (40.center) to (34.center);
		\draw [in=-150, out=90] (43.center) to (38);
		\draw [style=red] (44.center) to (43.center);
		\draw (45) to (36.center);
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [style=red] (32.center) to (31.center);
	\end{pgfonlayer}
\end{tikzpicture}
$$
...
\begin{tikzpicture}
	...
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [style=red, in=-90, out=45, looseness=0.75] (61) to (60.center);
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [style=red, in=-90, out=30] (62) to (65);
		\draw [style=red] (65) to (66.center);
	\end{pgfonlayer}
\end{tikzpicture}
=
\begin{tikzpicture}
	...
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [style=red] (107) to (108.center);
		\draw [style=red] (116.center) to (107);
...
\begin{tikzpicture}
	...
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [style=red, in=-90, out=135, looseness=0.75] (87) to (86.center);
...
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [style=red, in=-90, out=150] (13) to (15.center);
		\draw (18.center) to (20.center);
	\end{pgfonlayer}
\end{tikzpicture}
=
\begin{tikzpicture}
	...
	\begin{pgfonlayer}{edgelayer}
		...
		\draw [in=-90, out=150] (0) to (2.center);
		\draw [style=red] (2.center) to (10.center);
...
Just as Spekkens' toy model is an epistemically restricted toy theory of quantum circuits; by dualizing things, we could also ask what properties of quantum mechanics hold the dual picture $\Aff\Co\Isot\Rel_{\F_p}$.  This  is an empistemically restricted toy theory of quantum circuits; albeit the epistemic restriction is going in the wrong direction.
