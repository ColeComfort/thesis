...
%
%As we alluded to earlier,  the notion of factorization systems over subcategories was initially introduced in order to define distributive laws of  Cartesian monoidal props (often called Lawvere theories) \cite{lawvere}. We will give an example to this end.  To do so, first observe:
%
%\begin{lemma}
%The prop $\cb$ for a bicommutative bialgebra is Cartesian monoidal.  The 
%\end{lemma}
%
%%
...
%
%\end{example}
%The Lawvere theory of monoids $L_{\sf Mon}$ is presented by a distributive law of props of type $\cm^\op \otimes_\P \m$.  As usual, we will label the generators of $cm^\op$ with white circles, 
%
%
