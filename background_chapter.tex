...
Take a commutative Frobenius algebra. Then the circuits generated by the components of which are simply connected have a unique normal form. We use the spider notation on the right to refer to these simply connected components:
