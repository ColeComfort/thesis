...
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=map] (432) at (264, 7) {$\lfloor f \rfloor$};
		\node [style=none] (433) at (263.75, 8) {};
		\node [style=none] (434) at (264.25, 8) {};
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [in=60, out=-90] (434.center) to (432);
		\draw [in=270, out=120] (432) to (433.center);
	\end{pgfonlayer}
\end{tikzpicture}
:=
\begin{tikzpicture}
...
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=map] (441) at (264.25, 6.25) {$\lceil f \rceil$};
		\node [style=none] (442) at (264, 5.25) {};
		\node [style=none] (443) at (264.5, 5.25) {};
	\end{pgfonlayer}
	\begin{pgfonlayer}{edgelayer}
		\draw [in=-60, out=90] (443.center) to (441);
		\draw [in=-270, out=-120] (441) to (442.center);
	\end{pgfonlayer}
\end{tikzpicture}
:=
\begin{tikzpicture}
...
So far, the two fragments of the ZX-calculus we have described are relatively simple; they are actually fragments of stabilizer circuits:
...
Recently, generators hazve been proposed for the qudit ZH-calculus, but no completeness theorem exists so far \cite{roy}.
